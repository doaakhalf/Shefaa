...
<section class="white-bg pt-0 pb-0">
      ...
      @foreach($mydonation as $donation)
        ...
        <div class="col-md-3">
          ...
          @else
          <i class="icofont icofont-magic font-40px default-color"></i>
          <p style="color:red">Status:Accepted by Volunteer Name {{$donation->volunteer->name}}</p>

          @endif
     

          <!-- <h3>Status:pen</h3> -->
      @foreach($donation->donationMedication as $don)
              <div class="">
        				<h5 class="text-uppercase"></h5>
                        <p>  Medicine:{{$don->medicine[0]->name}}</p>
